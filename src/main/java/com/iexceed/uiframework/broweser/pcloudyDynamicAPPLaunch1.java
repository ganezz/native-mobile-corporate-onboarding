...
public class pcloudyDynamicAPPLaunch1 extends TestBase {
    ...
    private static final Logger log = LogManager.getLogger(pcloudyDynamicAPPLaunch1.class);
    public static Map<String, String> deviceConfigCopy;


    public pcloudyDynamicAPPLaunch1(Map<String, String> deviceConfig) throws Exception {
