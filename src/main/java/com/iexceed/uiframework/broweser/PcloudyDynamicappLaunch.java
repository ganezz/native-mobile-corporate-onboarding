...
public class PcloudyDynamicappLaunch extends TestBase {
    ...
    public static void chromeAPPlaunch() throws Exception {
        ...
        appURL = temp1 + arr[1];
        log.debug(appURL);
        String appURLtemp = "https://artifactory.appzillon.com/artifactory/sme-onboarding/corporate-onboarding-app/1.0.0/CorporateOnboarding.apk";
    ...
    public static void fileRenaming() throws Exception, NullPointerException {
        f2 = new File("CorporateOnboarding");
