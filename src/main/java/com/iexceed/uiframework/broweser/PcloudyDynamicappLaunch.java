...
public class PcloudyDynamicappLaunch extends TestBase {
    ...
    public static void chromeAPPlaunch() throws Exception {
        ...
        appURL = temp1 + arr[1];
        log.debug(appURL);
        String appURLtemp = "https://artifactory.appzillon.com/artifactory/android-apk/ao/manual/qaRelease-1.0.16-27-01-2022-10:18.apk";
    ...
    public static void fileRenaming() throws Exception, NullPointerException {
        f2 = new File("Automation-1-0-16-27-01-2022");
